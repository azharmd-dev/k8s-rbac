...
* Create service account
    ```
    eksctl create iamserviceaccount --cluster robomart-dev --name secret-reader --namespace robomart --attach-policy-arn arn:aws:iam::160885265516:policy/RoboShopMySQLSecretReader --approve
    ```
* Get secret value
    ```
